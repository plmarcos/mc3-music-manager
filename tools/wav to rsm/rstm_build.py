...
def build_tool_stamp(default_name="rstm_build.py"):
    ...
    with open(path, "rb") as file:
        ...
        if header == b"SShd":
            ...
            if ps2str:
                ...
                # MFAudio's cli parser expects quotes around paths; subprocess
                # handles that without going through a shell (no os.system, no
                # command injection via the file name) and honours the exit code.
